...
void I2C_Init(I2Cn i2cn)
{
    ...
    /* 设置频率 */
    I2C_F_REG(I2Cx[i2cn])  = I2C_F_MULT(0) | I2C_F_ICR(17) ;  //0x29
    // MULT=00  即  mul = 1
...
//简  例: IIC_init(I2C1);
//-------------------------------------------------------------------------*
void I2C_StartTransmission (I2Cn i2cn, int8 SlaveID, MSmode Mode)
{
...
//-------------------------------------------------------------------------*
int8 I2C_ReadAddr(I2Cn i2cn, int8 SlaveID, int8 Addr)
{
    int8 result;
...
//-------------------------------------------------------------------------*
void I2C_WriteAddr(I2Cn i2cn, int8 SlaveID, int8 Addr, int8 Data)
{
    /* send data to slave */
