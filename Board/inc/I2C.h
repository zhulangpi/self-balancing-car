...
void  I2C_WriteAddr(I2Cn, int8 SlaveID, int8 Addr, int8 Data);      //读取地址里的内容
void  I2C_StartTransmission (I2Cn, int8 SlaveID, MSmode);       //启动传输
int8    I2C_ReadAddr(I2Cn, int8 SlaveID, int8 Addr);                //往地址里写入内容
