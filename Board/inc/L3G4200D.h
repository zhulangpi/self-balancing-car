...
/*************************************************************/
/*********定义时钟线*********/
#define SCLout   gpio_init(PTD8, GPO, 0)//DDRC19=1
#define SCL_L_   PTD8_OUT=0
#define SCL_H_   PTD8_OUT=1
/*********定义数据线*********/
#define SDAout   gpio_init(PTD9, GPO, 0)//DDRD0=1
#define SDA_L_   PTD9_OUT=0
#define SDA_H_   PTD9_OUT=1
#define SDAin    gpio_init(PTD9, GPI, 0)//DDRA15=0
#define SDA_read PTD9_IN
...
/*************************************************************/
#define	L3G4200_Addr 0xD2       //ID:定义器件在IIC总线中的从地址
...
extern long int  L3G_read_reg(unsigned char n,unsigned char Axis);
...
extern long int MMA8451_read_reg(unsigned char n,unsigned char Axis);
