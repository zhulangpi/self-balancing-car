...
/* USB Variables & Flags */
extern uint8        guint8USB_Flags;
extern uint8        guint8USB_State;
extern tUSB_Setup *Setup_Pkt;
extern uint8        guint8EP2_IN_ODD_Buffer[];
extern uint8        guint8EP3_OUT_ODD_Buffer[];
extern uint8        *BufferPointer[];



extern tBDT         tBDTtable[];
extern uint8        guint8Interface;
...
uint16  USB_EP_OUT_SizeCheck(uint8 uint8EP);
